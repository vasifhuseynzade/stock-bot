...
def make_variants(base: StrategyConfig) -> List[StrategyConfig]:
    """V2.3 research basket: benchmark plus several genuinely different setup families."""
    v21b = replace(
        base,
        name="v2_1b_breakout_only_baseline",
        ...
        trail_tighten_r=999.0,
        trail_tighten_pct=0.05,
    ...
    rs_breakout = replace(
        ...
        breakout_min_rs_score=8,
        breakout_require_ma100=False,
        breakout_require_ma20_slope=True,
        breakout_min_rel_20_spy=-0.01,
        breakout_min_rel_63_spy=-0.03,
        breakout_min_rel_20_qqq=-0.04,
        breakout_require_55day_or_strong_rs=False,
        breakout_max_base_range_pct=0.45,
        breakout_max_extension_ma20=0.14,
        breakout_max_extension_atr=2.0,
        breakout_atr_stop_mult=1.80,
        breakeven_r=0.70,
        partial_r=1.0,
        partial_pct=0.08,
    ...
    pullback_reclaim = replace(
        base,
        name="v2_3_pullback_reclaim",
        ...
        min_score=70,
        pullback_min_score=74,
        reclaim_min_score=74,
        weak_min_score=88,
        max_signals_per_scan=4,
        min_avg_dollar_volume=50_000_000.0,
        pullback_min_volume_ratio=0.25,
        pullback_max_daily_move_pct=5.0,
        reclaim_rsi_min=34.0,
        reclaim_rsi_max=62.0,
        reclaim_max_extension_ma20=0.055,
        reclaim_min_close_location=0.55,
        pullback_atr_stop_mult=1.70,
        breakeven_r=0.70,
        partial_r=1.0,
        partial_pct=0.07,
        partial_fraction=0.50,
        trail_mult_before_5pct=2.7,
    ...
    hybrid = replace(
        ...
        allow_pullbacks=True,
        min_score=72,
        breakout_min_score=78,
        vcp_min_score=82,
        pullback_min_score=76,
        reclaim_min_score=76,
        weak_min_score=90,
        max_signals_per_scan=4,
        min_avg_dollar_volume=50_000_000.0,
        breakout_min_volume_ratio=1.15,
    ...
    cost_robust = replace(
        hybrid,
        name="v2_3_cost_robust_top2_no_weak",
        ...
        max_position_equity_pct=0.18,
        risk_boost_enabled=False,
    )

    macd_vcp = replace(
        vcp,
        name="v2_3_vcp_macd_confirmed",
    ...
    return [v21b, rs_breakout, vcp, pullback_reclaim, hybrid, cost_robust, macd_vcp]
